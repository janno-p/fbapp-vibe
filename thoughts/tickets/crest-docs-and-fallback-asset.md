...
source: .claude/tasks/done/0038-crest-docs-and-fallback-asset.md
source_id: 0038
source_status: done
source_title: Update crest/flag docs and add fallback crest asset
status: done
phase: MVP
type: chore
adrs: [0019]
...
ADR-0019 marked as superseded by ADR-0022. Created `docs/adr/0022-team-crest-images.md` documenting the full pivot from SVG → emoji → API crests. Created `assets/default.svg` (40×40, `#1e2f47` background, shield outline in `#4a6080`). No code changes — `src/crests.rs` was already correct.
