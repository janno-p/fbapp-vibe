...
source: .claude/tasks/TEMPLATE.md
source_id: 0000
source_status: open          # open | in-progress | done | cancelled
source_title: Short descriptive title
...
Everything needed to implement this task without asking clarifying questions. Work the ticket from `thoughts/` and update `## Outcome` when complete.
